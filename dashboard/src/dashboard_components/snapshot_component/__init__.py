...
def register_callback(app, API_IP, API_PORT):
    ...
    if 'private_dashboard' in os.environ and os.environ['private_dashboard'] == "True":
        ...
        def download_micro_cluster(n_clicks,session_id,selected_cluster_time,selected_cluster):
            if selected_cluster is not None:
                ...
                selected_cluster_time = np.datetime64(selected_cluster_time) - np.timedelta64(2, 'h')
    ...
    def display_cluster_data(selected_cluster, selected_cluster_options, selected_cluster_time, session_id, time_options):
        ...
        if selected_cluster is None or selected_cluster_time is None or selected_cluster_options == []:
            return "0", "0.00%", "0", "0", "0.00%", "0", None, [], None, "0", "0", "0.00%", "0", "0", "0", {}, {}, {}, {}, {},{},{}
        try:
        ...
        return texts_number, text_ids_growth_abs, text_ids_growth_rel, cluster_weight, weight_growth_abs, weight_growth_rel, texts_data, term_data, twt_users, users_in, verified_abs, verified_rel, texts_number, default_profile, default_image, followers_plot, liked_plot, user_tweets_plot, friends_plot, acc_ages_bar, acc_mc_statuses_bar, term_data
